      ...
      try {
        ...
        if (!ebook.product_description) {
          ...
          const mktAI = await aiJSON<Marketing>({
            model: mktModel,
            system: HARDSELL_COPYWRITER_SYSTEM + `\n\nYou are writing the storefront product page copy for a finished premium PDF ebook. Use ethical hard-sell copywriting — no fake scarcity, no guaranteed outcomes.`,
