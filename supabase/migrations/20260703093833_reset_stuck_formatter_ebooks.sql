-- Auto-fix: force re-render for 11 ebooks whose pdf_qc is missing v3 formatter
-- fields. Combined with the pipeline change that detects legacy pdf_qc, this
-- makes them converge on the next recovery tick.
